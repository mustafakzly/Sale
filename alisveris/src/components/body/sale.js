...
function Sale() {
    return ( 
        ...
        <div className='sale'>
            ...
            <div className='sale-box'>
                <img src='https://ideacdn.net/idea/ed/42/myassets/products/069/pngwing-com-5_min.png?revision=1697143329' alt=''/>
                <h3>Oslo Mermer Masa</h3>
                <p>25.998.00TL - <strike>332.233.51TL</strike> </p>
                <button>Sepete Ekle</button>
            </div>
            <div className='sale-box'>
                <img src='https://ideacdn.net/idea/ed/42/myassets/products/050/8799433392178-1543984368536_min.jpg?revision=1697143329' alt=''/>
                <h3>Oslo Mermer Masa</h3>
                <p>7.900.000.00TL</p>
                <button>Sepete Ekle</button>
            </div>      
