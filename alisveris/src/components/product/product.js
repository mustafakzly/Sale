    ...
    <div className="product">
      <div className="product-img">
        {product.attributes.image.data.map((imageItem, index) => (
          <img
            key={index}
            src={`http://192.168.1.106:1337${imageItem.attributes.url}`}
      ...
      <div className="product-detail">
        ...
        <div className="product-counter">
          <button className="product-counter-btn" onClick={decreaseQuantity}>
            -
          </button>
          <p>{quantity}</p>
          <button className="product-counter-btn" onClick={increaseQuantity}>
            +
          </button>
        </div>
